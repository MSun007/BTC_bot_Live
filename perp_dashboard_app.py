...
<section class="card span12"><h2>Independent Position Legs</h2><div class="pnl-note" id="legSummary">Loading core/add reconciliation…</div><div class="leg-grid" id="positionLegGrid"></div><div class="version-note" id="deploymentVersion">Dashboard v46 · deployed 2026-08-10</div></section>
