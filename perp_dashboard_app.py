...
<section class="hero"><div class="top"><div><div class="eyebrow">LARRY INTELLIGENCE</div><div class="title">Crypto Research Lab</div><div class="sub">Testing cross-asset clues around Bitcoin - without touching the live trading engine.</div></div><div class="actions"><span class="pill safe">RESEARCH ONLY</span><a class="pill" href="/">Back to Command Center</a></div></div><div class="warning" id="notice">Loading CoinGecko research history...</div></section>
